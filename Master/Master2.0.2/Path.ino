...
void LSRB(){
    ...
    if(led_path_left == 1 && led_path_front == 1 && led_path_right == 1 ){digitalWrite(13,LOW);    //check end left
    checkEndLeft();
    }
    LSRBalgo();
}
...
void RSLB(){
    ...
    if(led_path_left == 1 && led_path_front == 1 && led_path_right == 1 ){digitalWrite(13,LOW);    //check end right
    checkEndRight();
    }
    RSLBalgo();
}
